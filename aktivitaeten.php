    ...
    <div class="wrapper">
        ...
        <main class="main-aktivitaeten">
            <div class="sommer">
                ...
                <h3 class="card-heading">Im Sommer</h3>
    ...
    " class="activity-links">Kultur im Sommer</a>
            ...
            <div class="winter">
                <div class="image-and-heading">
                    ...
                    <h3 class="card-heading">im Winter</h3>
                </div>

                <ul class="activity-ul">
                    <li>
                        <img src="assets/Icons/HikingBootWinter.svg" alt="Bergschuhe" class="activity-icon">
                        <p>Wandern</p>
                        <span class="activity-text">Mit Schneeschuhen durch den Schnee zu laufen ist ein besonderes Erlebnis. Falls Sie Schneeschuhe besitzen, nehmen Sie diese bitte mit. Denn eine Schneeschuhwanderung gehört zu einem Winterurlaub im Bregenzerwald dazu.</span>
                        <a href="https://www.bregenzerwald.at/thema/schneeschuhwandern-tourentipps/" class="activity-links">Wandern im Winter</a>
                    </li>
                    <li>
                        <img src="assets/Icons/Skiing.svg" alt="Bergschuhe" class="activity-icon">
                        <p>skifahren</p>
                        <span class="activity-text">Skifahrer schätzen die Skigebiete im Bregenzerwald für ihre Vielseitigkeit. Der Anfänger kommt auf seine Kosten, aber auch der Fortgeschrittene kommt auf keinen Fall zu kurz. Alle Skigebiete sind mit dem 3-Täler-Skipass verbunden. </span>
                        <a href="https://www.bregenzerwald.at/thema/skifahren/" class="activity-links">Mehr zum Thema Skifahren</a>
                    </li>
                    <li>
                        <img src="assets/Icons/Rodel.svg" alt="Bergschuhe" class="activity-icon">
                        <p>rodeln</p>
                        <span class="activity-text">Da die Ferienwohnung Flatz etwas abseits des Dorfkerns liegt können sie direkt vor Ihrer Eingangstür los rodeln. Zusätzlich dazu gibt es im Bregenzerwald zahlreiche Rodelstrecken die Spaß garantieren.</span>
                        <a href="https://www.bregenzerwald.at/thema/rodeln/" class="activity-links">Mehr zum Thema Rodeln</a>
                    </li>
                    <li>
                        <img src="assets/Icons/langlaufen.svg" alt="Bergschuhe" class="activity-icon">
                        <p>Langlaufen</p>
                        <span class="activity-text">Wenn Sie nicht unbedingt Skifahren wollen aber trotzdem an die frische Luft, dann ist Langlaufen eine super Alternative. Die Loipen eignen sich für Anfänger sowie auch für Fortgeschrittene. </span>
                        <a href="https://www.bregenzerwald.at/thema/langlaufen/" class="activity-links">Mehr zum Thema Langlaufen</a>
                    </li>
                    <li>
